...
// Log the index of word "you" in message
  console.log(`The index of the word "you" in message is ${message.indexOf("you")}`);

// Log the index of word "still" in message
console.log(`The index of the word "still" in message is ${message.indexOf("still")}`);
...
console.log(message.slice(-6) === 'no!');
